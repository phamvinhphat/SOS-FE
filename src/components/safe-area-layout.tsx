...
import { Layout, LayoutProps, StyledComponentProps, useTheme } from '@ui-kitten/components';

type Inset = 'top' | 'bottom';

export interface SafeAreaLayoutProps extends StyledComponentProps, Omit<LayoutProps, 'appearance'> {
    insets?: Inset;
