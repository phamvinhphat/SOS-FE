...
export const ArrowIosBackIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="arrow-ios-back" />;

export const ArrowIosForwardIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="arrow-ios-forward" />;
...
export const BookmarkOutlineIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="bookmark-outline" />;

export const ColorPaletteIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="color-palette-outline" />;
...
export const LayoutIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="layout-outline" />;
...
export const MoreVerticalIcon = (style?: ImageStyle): IconElement => <Icon {...style} name="more-vertical" />;
...
export const AssetAuthIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="auth" />;

export const AssetAuthDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="auth-dark" />;

export const AssetSocialIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="social" />;

export const AssetSocialDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="social-dark" />
);

export const AssetArticlesIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="articles" />;

export const AssetArticlesDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="articles-dark" />
);

export const AssetMessagingIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="messaging" />;
...
export const AssetEcommerceIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="ecommerce" />;
...
export const AssetAvatarIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="avatar" />;
...
export const AssetButtonIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="button" />;
...
export const AssetCalendarIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="calendar" />;

export const AssetCalendarDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="calendar-dark" />
);

export const AssetCardIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="card" />;

export const AssetCardDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="card-dark" />;

export const AssetCheckBoxIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="check-box" />;
...
export const AssetDrawerIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="drawer" />;

export const AssetDrawerDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="drawer-dark" />
);

export const AssetIconIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="icon" />;

export const AssetIconDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="icon-dark" />;

export const AssetInputIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="input" />;

export const AssetInputDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="input-dark" />;

export const AssetListIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="list" />;

export const AssetListDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="list-dark" />;

export const AssetMenuIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="menu" />;

export const AssetMenuDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="menu-dark" />;

export const AssetModalIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="modal" />;

export const AssetModalDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="modal-dark" />;
...
export const AssetPopoverIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="popover" />;

export const AssetPopoverDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="popover-dark" />
);

export const AssetRadioIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="radio" />;

export const AssetRadioDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="radio-dark" />;

export const AssetSelectIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="select" />;

export const AssetSelectDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="select-dark" />
);

export const AssetSpinnerIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="spinner" />;

export const AssetSpinnerDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="spinner-dark" />
);

export const AssetTabViewIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="tab-view" />;

export const AssetTabViewDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="tab-view-dark" />
);

export const AssetTextIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="text" />;

export const AssetTextDarkIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="text-dark" />;

export const AssetToggleIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="toggle" />;

export const AssetToggleDarkIcon = (style?: ImageStyle): IconElement => (
    <Icon {...style} pack="app" name="toggle-dark" />
);

export const AssetTooltipIcon = (style?: ImageStyle): IconElement => <Icon {...style} pack="app" name="tooltip" />;
