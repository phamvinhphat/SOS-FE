...
import { Card, CardElement, List, ListElement, ListProps, Layout, Text } from '@ui-kitten/components';
...
export const LayoutGridList = (props: LayoutGridListProps): ListElement => {
    ...
    const renderItem = (info: ListRenderItemInfo<LayoutItem>): CardElement => {
        const renderItemHeader = (evaProps: any): React.ReactElement => (
            <Layout {...evaProps}>
        ...
        return (
            <Card style={styles.itemContainer} header={renderItemHeader} onPress={() => onItemPress(info.index)}>
